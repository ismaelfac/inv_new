                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <div class="input-group-text">Estado del Usuario</div>
                            ...
                            <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="is_active" id="exampleRadios1" value="0" checked>
                            <label class="form-check-label" for="exampleRadios1">
                                Desactivar
                            </label>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                                ...
                                <h5 class="mb-1"><small>{!! Form::radio('roles_unique[]', $role_unique->id, null) !!}</small> {{ $role_unique->name}}</h5>
                                <small>({{ $role_unique->special === 'no-access' ? 'Sin Acesso' : 'Acceso Total' }})</small>
                                </div>
